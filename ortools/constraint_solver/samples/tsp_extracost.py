...
def main():
    ...
    # Set extra cost complicated example
    solver = routing.solver()
    extracost = solver.IntVar(0, 500, "test")
    solver.Add((((routing.NextVar(5)==8)+(routing.NextVar(8)==5))*500)<=(extracost)) # why this does not work???
    routing.AddExtraCostVar(extracost)
